...
const ProjectCard = ({ children, img, title, desc, repo, prod, isNew, deprecated, school }) => {
    return (
        <div className="card m-3">
            <img className="card-img-top" src={ img } alt={ title } />
            <div className="card-body">
                <div className="d-flex flex-wrap">
                    { (isNew) ? (<h5><span className="badge badge-pill badge-success mr-2">New</span></h5>) : ('') }
                    { (school) ? (<h5><span className="word-break badge badge-pill badge-info mr-2">School Project</span></h5>) : ('') }
