            ...
            <div className="min-vh-100">
                <div className="d-flex justify-content-center flex-wrap">
                    ...
                    <div className="m-3 d-flex flex-column flex-wrap content text-break blurBg">
                        ...
                        <h4 className="mt-1"><span style={{ color: '#569CD6' }}>const</span> <span style={{ color: '#CCDF32' }}>languages</span> = <span style={{ color: '#569CD6' }}>[</span><span style={{ color: '#CE9178' }}>'French (Native)'</span><span>,</span><span style={{ color: '#CE9178' }}> 'English (C1)'</span><span>,</span><span style={{ color: '#CE9178' }}> 'Spanish (A2)'</span><span style={{ color: '#569CD6' }}>]</span>;</h4>
