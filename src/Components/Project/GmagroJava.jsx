...
import mockup from '../../assets/E4/Desktop/gmagrodesktop-mockup.png';
            ...
            <div className="min-vh-100 d-flex justify-content-center align-items-center">
                <div className="d-flex justify-content-center flex-wrap">
                    ...
                    <div className="m-3 d-flex flex-column flex-wrap content text-break blurBg">
                        <h3 className="title mb-4" style={{ color: '#43BC90'}}>&lt;GMAGRO Desktop Version /&gt;</h3>
                        ...
                        <p className="biography ml-5">
                            Lol trop cool gmagro pour lé pc mdr ^^
                        </p>
